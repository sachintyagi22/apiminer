 ...
 * {@link com.kb.miner.algorithms.gSpan.RightMostExtension} class) and the resulting depth
 * first search canonical code (see the {@link com.kb.miner.algorithms.gSpan.DFSCode} class).
 * <p>  
