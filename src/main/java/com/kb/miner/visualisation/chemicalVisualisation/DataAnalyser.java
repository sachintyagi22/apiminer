 ...
 */
package com.kb.miner.visualisation.chemicalVisualisation;
...
import com.kb.miner.utils.GraphCycleInformation;
	...
	public DataAnalyser(final String sequence) {
		...
		try {
			...
			m_graph = myParser.parse(
					sequence,
					new HPListGraph.Factory(myParser.getNodeParser(), myParser
