 ...
 */
package com.kb.miner.miner.environment;

import com.kb.miner.chemical.Atom;
import com.kb.miner.chemical.Bond;
import com.kb.miner.graph.Graph;
import com.kb.miner.graph.GraphFactory;
import com.kb.miner.graph.HPListGraph;
import com.kb.miner.jp.JavaPartyStrategy;
import com.kb.miner.miner.chain.MiningStepFactory;
import com.kb.miner.miner.general.Frequency;
import com.kb.miner.miner.general.IntFrequency;
import com.kb.miner.parsers.*;
import com.kb.miner.strategy.BFSStrategy;
import com.kb.miner.strategy.RecursiveStrategy;
import com.kb.miner.strategy.Strategy;
import com.kb.miner.strategy.ThreadedDFSStrategy;
...
public final class Settings<NodeType, EdgeType> {
	...
	private final static <NodeType, EdgeType> Settings<NodeType, EdgeType> create(
		...
		if (set.algorithm == null) {
			set.algorithm = new com.kb.miner.algorithms.gSpan.Algorithm<NodeType, EdgeType>();
		}
	...
	private final static <NodeType, EdgeType> boolean parseOption(
		...
		if (temp[0].equals("--help")) {
			...
			if (temp[1].equals("gspan")) {
				...
				set.algorithm = new com.kb.miner.algorithms.gaston.Algorithm<NodeType, EdgeType>();
			} else if (temp[1].equals("dagma")) {
				set.algorithm = new com.kb.miner.algorithms.dagminer.Algorithm<NodeType, EdgeType>();
	...
	public com.kb.miner.algorithms.Algorithm<NodeType, EdgeType> algorithm;
