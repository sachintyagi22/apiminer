 ...
 * <ul>
 *   <li> object orientated graphs (see the {@link com.kb.miner.graph.Graph},
 *   {@link com.kb.miner.graph.Node}, and {@link com.kb.miner.graph.Edge} interfaces)</li>
 *   <li> high performance graphs represented by int-arrays (see the 
 *   {@link com.kb.miner.graph.HPGraph} interface)</li>
 * </ul> 
