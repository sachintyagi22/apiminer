...
public class EclipseStatementAdapter {
	...
	public static final Logger logger = LoggerFactory
			.getLogger(EclipseStatementAdapter.class);
	
	private EclipseExpressionAdapter eclipseExpressionAdapter;
	private ClassVariableResolver resolver;
	private CompilationUnit unit;
	
	public EclipseStatementAdapter(ClassVariableResolver resolver, CompilationUnit unit) {
	...
	private List<Statement> translate(
		...
		if (stmt instanceof org.eclipse.jdt.core.dom.ReturnStatement) {
			...
			Type type = EclipseExpressionAdapter
					.translateType(t);
